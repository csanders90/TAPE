...
# python wb_tune_struc2vec.py --sweep core/yamls/arxiv_2023/struc2vec_sp2.yaml --cfg core/yamls/arxiv_2023/struc2vec.yaml 
python wb_tune_struc2vec.py --sweep core/yamls/arxiv_2023/struc2vec_sp3.yaml --cfg core/yamls/arxiv_2023/struc2vec.yaml 
